const connection = new WebSocket("wss://idealisticcruelautotote.ruatube.repl.co");
...
window.onblur = function () {
    ...
    if (name.value != '') {
      const data = `<p><strong style='color: red'>SYSTEM | ${name.value}</strong> left the room.</p>`;
